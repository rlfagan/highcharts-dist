...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/marker-clusters.src.js', [_modules['parts/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Options.js'], _modules['parts/Point.js'], _modules['parts/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Chart, H, O, Point, SVGRenderer, U) {
        /* *
         *
