...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/funnel3d.src.js', [_modules['Core/Globals.js'], _modules['parts-3d/Math.js'], _modules['Core/Color.js'], _modules['Core/Utilities.js']], function (H, Math3D, Color, U) {
        /* *
         *
