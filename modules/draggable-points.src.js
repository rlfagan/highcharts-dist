...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/draggable-points.src.js', [_modules['Core/Globals.js'], _modules['parts/Point.js'], _modules['Core/Utilities.js']], function (H, Point, U) {
        /* *
         *
